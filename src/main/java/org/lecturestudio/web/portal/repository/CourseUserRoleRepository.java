...
@Repository
public interface CourseUserRoleRepository extends JpaRepository<CourseUserRole, CourseUserRoleId> {

	@Query(value = "SELECT role FROM CourseUserRole cur WHERE cur.course.id = ?1 AND cur.username = ?2")
